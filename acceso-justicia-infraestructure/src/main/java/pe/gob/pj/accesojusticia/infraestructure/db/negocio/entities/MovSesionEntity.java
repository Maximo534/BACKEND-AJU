...
@Entity
@Table(name = "MOV_SESION", schema = EsquemaConstants.PRUEBA)
public class MovSesionEntity implements Serializable {

    static final long serialVersionUID = 1L;

    @Id
    @SequenceGenerator(name = "SEQ_MOV_SESION", schema = EsquemaConstants.PRUEBA, sequenceName = "USEQ_MOV_SESION", initialValue = 1, allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_MOV_SESION")
    @Column(name = "N_SESION_ID")
    Long id;

    @Column(name = "N_USUARIO_ID")
    Integer idUsuario;
    ...
    String lActivo = Estado.ACTIVO_NUMERICO.getNombre();
}