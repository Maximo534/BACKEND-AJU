package pe.gob.pj.accesojusticia.infraestructure.db;
...
@EnableJpaRepositories(basePackages = "pe.gob.pj.accesojusticia.infraestructure.db.seguridad.repositories",
...
public class SeguridadConfig {
  ...
  LocalContainerEntityManagerFactoryBean seguridadEntityManagerFactory(
    ...
    return builder.dataSource(dataSource)
        .packages("pe.gob.pj.accesojusticia.infraestructure.db.seguridad.entities")
