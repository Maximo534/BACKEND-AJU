...
@EnableJpaRepositories(
    basePackages = "pe.gob.pj.accesojusticia.infraestructure.db.auditoriageneral.repositories",
...
public class AuditoriaGeneralConfig {
  ...
  LocalContainerEntityManagerFactoryBean auditoriaEntityManagerFactory(
    ...
    return builder.dataSource(dataSource)
        .packages("pe.gob.pj.accesojusticia.infraestructure.db.auditoriageneral.entities")
