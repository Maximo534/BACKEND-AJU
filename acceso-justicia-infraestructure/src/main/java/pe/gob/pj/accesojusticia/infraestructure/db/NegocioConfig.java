...
@EnableJpaRepositories(basePackages = "pe.gob.pj.accesojusticia.infraestructure.db.negocio.repositories",
...
//        .lookup("java:jboss/datasources/servicioPruebaAPINegocio");
  ...
  LocalContainerEntityManagerFactoryBean negocioEntityManagerFactory(
    ...
    return builder.dataSource(dataSource)
        .packages("pe.gob.pj.accesojusticia.infraestructure.db.negocio.entities")
