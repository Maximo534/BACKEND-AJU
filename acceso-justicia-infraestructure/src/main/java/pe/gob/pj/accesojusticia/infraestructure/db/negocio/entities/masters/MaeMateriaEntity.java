...
@Entity
@Table(name = "mae_materia", schema = EsquemaConstants.PRUEBA)
public class MaeMateriaEntity implements Serializable {

    static final long serialVersionUID = 1L;

    @Id
    @SequenceGenerator(name = "SEQ_MAE_MATERIA", schema = EsquemaConstants.PRUEBA, sequenceName = "useq_mae_materia", initialValue = 1, allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_MAE_MATERIA")
    @Column(name = "n_materia_id", nullable = false)
    Long id;
