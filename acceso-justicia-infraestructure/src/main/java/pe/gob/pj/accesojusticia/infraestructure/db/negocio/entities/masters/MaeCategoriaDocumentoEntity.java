...
@Entity
@Table(name = "mae_categoria_documento", schema = EsquemaConstants.PRUEBA)
public class MaeCategoriaDocumentoEntity implements Serializable {

    static final long serialVersionUID = 1L;

    @Id
    @SequenceGenerator(name = "SEQ_MAE_CAT_DOC", schema = EsquemaConstants.PRUEBA, sequenceName = "useq_mae_categoria_documento", initialValue = 1, allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_MAE_CAT_DOC")
    @Column(name = "n_categoria_doc_id", nullable = false)
    Long id;

    @Column(name = "x_descripcion", length = 255, nullable = false)
    String descripcion;
