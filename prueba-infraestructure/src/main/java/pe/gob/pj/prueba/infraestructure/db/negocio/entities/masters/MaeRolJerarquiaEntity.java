...
@Entity
@Table(name = "mae_rol_jerarquia", schema = EsquemaConstants.PRUEBA) // Asegúrate que PRUEBA apunte a "acjust"
public class MaeRolJerarquiaEntity implements Serializable {

    static final long serialVersionUID = 1L;

    @Id
    @SequenceGenerator(name = "SEQ_MAE_JERARQUIA", schema = EsquemaConstants.PRUEBA, sequenceName = "useq_mae_rol_jerarquia", initialValue = 1, allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_MAE_JERARQUIA")
    @Column(name = "n_jerarquia_id", nullable = false)
    Long id;

    @Column(name = "n_rol_padre", nullable = false)
    Integer idRolPadre;

    @Column(name = "n_rol_hijo", nullable = false)
    Integer idRolHijo;
