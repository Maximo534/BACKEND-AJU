...
//    }
//
//    private String obtenerNombreCorte(Long id) { return repoDistritoJud.findById(id).map(e -> e.getNombre()).orElse(id); }
//    private String obtenerNombreEje(Long id) { return repoEje.findById(id).map(e -> e.getDescripcion()).orElse(id); }
//    private String obtenerNombreDepa(Long id) { return repoDepa.findById(id).map(e -> e.getNombre()).orElse(id); }
//    private String obtenerNombreProv(Long id) { return repoProv.findById(id).map(e -> e.getNombre()).orElse(id); }
//    private String obtenerNombreDist(Long id) { return repoDist.findById(id).map(e -> e.getNombre()).orElse(id); }
//    private String obtenerNombreTambo(Long id) { return repoTambo.findById(id).map(e -> e.getNombre()).orElse(id); }
