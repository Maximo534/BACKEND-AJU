...
@Entity
@Table(name = "mae_tipo_vulnerabilidad", schema = EsquemaConstants.PRUEBA)
public class MaeTipoVulnerabilidadEntity implements Serializable {

    static final long serialVersionUID = 1L;

    @Id
    @SequenceGenerator(name = "SEQ_MAE_TIPO_VULN", schema = EsquemaConstants.PRUEBA, sequenceName = "useq_mae_tipo_vulnerabilidad", initialValue = 1, allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_MAE_TIPO_VULN")
    @Column(name = "n_tipo_vuln_id", nullable = false)
    Long id;
