...
public interface JusticiaItineranteMapper {
    ...
    @Mapping(target = "numMujeresIndigenas", source = "numMujeresIndigenas", defaultValue = "0")
    @Mapping(target = "numPersonasNoIdiomaNacional", source = "numPersonasNoIdiomaNacional", defaultValue = "0")
    @Mapping(target = "numJovenesQuechuaAymara", source = "numJovenesQuechuaAymara", defaultValue = "0")
