...
@Entity
@Table(name = "MAE_SEDE", schema = EsquemaConstants.PRUEBA)
public class MaeSedeEntity implements Serializable {

    static final long serialVersionUID = 1L;

    @Id
    @SequenceGenerator(name = "SEQ_MAE_SEDE", schema = EsquemaConstants.PRUEBA,
            sequenceName = "USEQ_MAE_SEDE", initialValue = 1, allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_MAE_SEDE")
