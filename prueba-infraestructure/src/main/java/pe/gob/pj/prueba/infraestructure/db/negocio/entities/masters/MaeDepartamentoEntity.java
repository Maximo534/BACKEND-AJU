...
@Entity
@Table(name = "mae_departamento", schema = EsquemaConstants.PRUEBA)
public class MaeDepartamentoEntity implements Serializable {

    static final long serialVersionUID = 1L;

    @Id
    @SequenceGenerator(name = "SEQ_MAE_DEPA", schema = EsquemaConstants.PRUEBA, sequenceName = "useq_mae_departamento", initialValue = 1, allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_MAE_DEPA")
    @Column(name = "n_dep_id", nullable = false)
    Long id;

    @Column(name = "c_codigo", length = 2, nullable = false)
    String codigo;
